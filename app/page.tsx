...
export default function DeckPicker() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-deep-dark via-[#0D1B2A] to-[#0F1D2F] flex items-center justify-center p-8">
      <div className="w-full max-w-3xl">
        <h1 className="text-3xl font-bold text-white mb-2">Verdaxis Decks</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {deckList.map((deck) => (
            <Link
              key={deck.slug}
              href={`/${deck.slug}`}
              className="group relative rounded-2xl bg-white/[0.04] border border-white/10 p-6 hover:border-verdaxis-blue/40 hover:bg-verdaxis-blue/[0.04] transition-all duration-300"
            >

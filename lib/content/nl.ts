...
export const nl: DeckContent = {
  slides: {
    ...
    demo: { title: "Bekijk het in Actie", section: "Product" },
  ...
  whyNow: {
    ...
    drivers: [
      ...
      },
      {
        ...
        description: "Chinese methanolproductiecapaciteit stijgt sterk \u2014 100M+ ton tegen 2026. Bio Methanol-projecten schalen op in Europa en Azi\u00eb. e-Methanolpilots starten in Scandinavi\u00eb en het Midden-Oosten.",
        iconKey: "supply",
      },
      {
  ...
  traction: {
    ...
    milestones: [
      { title: "Platform MVP Lancering", date: "Q2 2026" },
      { title: "Compliance Engine v1", date: "Q2 2026" },
      { title: "AI Copilot B\u00e8ta", date: "Q3 2026" },
      { title: "Eerste Omzet", date: "Q3 2026" },
      { title: "Oprichtersleden-programma", date: "Q3 2026" },
    ],
  },
    ...
    phases: [
      ...
      },
      {
        ...
        items: [
          ...
          "Nieuwe brandstoftypen (Bio Ethanol, Bio Methanol, e-Methanol, Synthetic Ethanol)",
  ...
  demo: {
    heading: "Bekijk Verdaxis in Actie",
    subtitle: "Bekijk een echte transactiestroom — van zoeken tot afwikkeling, beide zijden van de marktplaats",
    buyer: {
      label: "Koper",
      sublabel: "Inkoop",
      steps: ["Zoeken", "Bladeren", "Selecteren", "Bevestigd"],
    },
    seller: {
      label: "Verkoper",
      sublabel: "Aanbod",
      steps: ["Aanmaken", "Gepubliceerd", "Gematcht", "Voltooid"],
    },
    ui: {
      ...
      certificateOfOrigin: "Certificaat van Oorsprong",
      fueleuCompliance: "FuelEU Naleving",
      euEtsAllowances: "EU ETS Emissierechten",
      paymentSecured: "Betaling beveiligd via escrow",
      createListing: "Nieuw Aanbod Aanmaken",
      publishListing: "Aanbod Publiceren",
      listingPublished: "Aanbod Gepubliceerd",
      ...
      status: "Status",
      active: "Actief",
      newBuyerInquiry: "Nieuwe Kopersaanvraag!",
      buyerProfile: "Kopersprofiel",
      verifiedBuyer: "Geverifieerde Koper",
      fleet: "scheepsvloot",
      wants: "Wenst",
      yourPrice: "Uw Prijs",
      buyerBid: "Bod Koper",
      acceptDeal: "Deal Accepteren",
      transactionComplete: "Transactie Voltooid",
      settlement: "Afwikkeling",
      paymentLabel: "Betaling",
      secured: "Beveiligd",
      certificatesLabel: "Certificaten",
      issued: "Uitgegeven",
      complianceLabel: "Naleving",

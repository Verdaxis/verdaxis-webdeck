...
export const pt: DeckContent = {
  ...
  traction: {
    ...
    milestones: [
      { title: "Lançamento do MVP da Plataforma", date: "T2 2026" },
      { title: "Motor de Conformidade v1", date: "T2 2026" },
      { title: "Copiloto IA Beta", date: "T3 2026" },
      { title: "Primeira Receita", date: "T3 2026" },
      { title: "Programa de Membros Fundadores", date: "T3 2026" },
    ],
  },

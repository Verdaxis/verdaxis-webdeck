...
export const zh: DeckContent = {
  ...
  traction: {
    ...
    milestones: [
      { title: "平台 MVP 上线", date: "2026年第二季度" },
      { title: "合规引擎 v1", date: "2026年第二季度" },
      { title: "AI 智能助手 Beta 版", date: "2026年第三季度" },
      { title: "首笔收入", date: "2026年第三季度" },
      { title: "创始会员计划", date: "2026年第三季度" },
    ],
  },
  ...
  demo: {
    heading: "观看 Verdaxis 实机演示",
    subtitle: "观看真实交易流程——从搜索到结算，涵盖市场双方",
    buyer: {
      label: "买方",
      sublabel: "采购",
      steps: ["搜索", "浏览", "选择", "已确认"],
    ...
    ui: {
      ...
      fueleuCompliance: "FuelEU 合规",
      euEtsAllowances: "EU ETS 配额",
      paymentSecured: "付款已通过托管账户保障",
      createListing: "创建新挂牌",
      publishListing: "发布挂牌",

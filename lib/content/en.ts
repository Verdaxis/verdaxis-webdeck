...
export const en: DeckContent = {
  slides: {
    ...
    demo: { title: "See It in Action", section: "Product" },
  ...
  demo: {
    heading: "See Verdaxis in Action",
    subtitle: "Watch a real transaction flow — from search to settlement, both sides of the marketplace",
    buyer: {
      label: "Buyer",
      sublabel: "Procurement",
      steps: ["Search", "Browse", "Select", "Confirmed"],
    },
    seller: {
      label: "Seller",
      sublabel: "Supply",
      steps: ["List", "Published", "Matched", "Complete"],
    },
    ui: {
      fuelType: "Fuel Type",
      port: "Port",
      ...
      fueleuCompliance: "FuelEU Compliance",
      euEtsAllowances: "EU ETS Allowances",
      paymentSecured: "Payment secured via escrow",
      ...
      status: "Status",
      active: "Active",
      newBuyerInquiry: "New Buyer Inquiry!",

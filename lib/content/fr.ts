...
export const fr: DeckContent = {
  ...
  traction: {
    ...
    milestones: [
      { title: "Lancement du MVP", date: "T2 2026" },
      { title: "Moteur de Conformit\u00e9 v1", date: "T2 2026" },
      { title: "Copilote IA B\u00eata", date: "T3 2026" },
      { title: "Premiers Revenus", date: "T3 2026" },
      { title: "Programme Membres Fondateurs", date: "T3 2026" },
    ],
  },
